module EOS_Omni_Module
  ...
  ! conversion between temperature in K and in MeV
  real*8,parameter :: temp_gf = 8.617332478d-11
  ...
  real*8,parameter :: inv_temp_gf = 1.1604519177518033d10

  real*8,parameter :: clite = 2.99792458d10
  real*8,parameter :: cliteinv2 = 1.11265005605362d-21
  real*8,parameter :: kBerg   = 1.38064852e-16
  ...
  real*8, allocatable :: hybrid_eps(:)
  real*8, allocatable :: hybrid_k(:)
